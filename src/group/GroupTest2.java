...
public class GroupTest2 {
	private static final String INPUT_PATH = "hdfs://122.0.67.167:8020/18681163341/twocol";
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, GroupTest2.class.getSimpleName());
		job.setJarByClass(GroupTest2.class);
	...
	public static class MyMapper extends Mapper<LongWritable, Text, TwoColumns, IntWritable>{
		...
		protected void map(LongWritable key, Text value,
			...
			v2.set(Integer.parseInt(split[0]));
			context.write(k2, v2);
		}
	}
	...
	public static class MyGroupComparator implements RawComparator<TwoColumns>{
		...
		public int compare(byte[] b1, int s1, int l1, byte[] b2, int s2, int l2) {
			return WritableComparator.compareBytes(b1, 3, 4, b2, 3, 4);
		}

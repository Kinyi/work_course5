...
public class GroupTest3 {
	private static final String INPUT_PATH = "hdfs://122.0.67.167:8020/18681163341/t";
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, GroupTest3.class.getSimpleName());
		job.setJarByClass(GroupTest3.class);
